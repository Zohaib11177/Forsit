...
export const getProductApi = (data) => {
    return axios({
        method: "get",
        url: process.env.REACT_APP_URLL + "product/list-admin",
    })
}
...
export const createProductApi = (product) => {
    ...
    return axios({
        method: "post",
        url: process.env.REACT_APP_URLL + "product/add",
        data: product
    })
}
export const EditUProductApi = (product,id) => {
    console.log("product",product)
    return axios({
        method: "put",
        url: process.env.REACT_APP_URLL + "product/quick-edit/"+ id,
        data: product
    })
}
